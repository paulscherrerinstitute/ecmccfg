#-d /**
#-d   \brief hardware script for ELM360X for +-1.25V range
#-d   \details Parametrization of ELM360X for +-1.25V range used for voltage measurement (not IEPE)
...
#- +-1.25V Setting (100)
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x80${ECMC_SDO_ID_LOCAL}0,0x1,100,2)"
