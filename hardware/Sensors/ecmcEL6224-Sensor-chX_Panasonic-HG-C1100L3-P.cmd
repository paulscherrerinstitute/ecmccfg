...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1A0${ECMC_EC_PDO_ID},0x60${ECMC_EC_PDO_ID}0,0x01,S32,analogInput${ECMC_EC_CH_ID})"
