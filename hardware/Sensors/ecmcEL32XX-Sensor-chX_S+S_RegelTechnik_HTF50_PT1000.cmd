#-d /**
#-d   \brief hardware script for EL32XX-Sensor-chX_S+S_RegelTechnik_HTF50_PT1000
...
############################################################
############# Parametrization of EL32X4 for S+S Regeltechnik HFT50 PT1000 sensor
#- Type: PT1000
...
epicsEnvSet("ECMC_EC_SDO_SIZE",          "2")
epicsEnvSet("ECMC_EC_SDO_VALUE",         "2")  # PT1000
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},${ECMC_EC_SDO_INDEX},$(ECMC_EC_SDO_INDEX_OFFSET),$(ECMC_EC_SDO_VALUE),$(ECMC_EC_SDO_SIZE))"
...
#- Calibration of supply lines (in 1/32 Ω):
#- Cable length = 1.5m
#- Wire area: 0.25mm²
