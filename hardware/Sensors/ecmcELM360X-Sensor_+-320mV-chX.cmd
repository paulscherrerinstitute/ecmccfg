#-d /**
#-d   \brief hardware script for ELM360X for +-320mV range
#-d   \details Parametrization of ELM360X for +-320mV range used for voltage measurement (not IEPE)
...
#- +-320mV Setting (102)
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x80${ECMC_SDO_ID_LOCAL}0,0x1,102,2)"
