#-d /**
#-d   \brief hardware script for ELM360X for +-40mV range
#-d   \details Parametrization of ELM360X for +-40mV range used for voltage measurement (not IEPE)
...
#- +-40mV Setting (105)
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x80${ECMC_SDO_ID_LOCAL}0,0x1,105,2)"
