#-d /**
#-d   \brief hardware script for EL6624-Sensor-chX_output
#-d   \details Parametrization of chX of EL6624 as a generic output
...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,2,0x160${ECMC_EC_CH_ID},0x70${ECMC_EC_CH_ID}0,0x01,U16,BO_${ECMC_EC_CH_ID_TEXT})"
...
epicsEnvSet("ECMC_EC_SDO_SIZE",          "2")
epicsEnvSet("ECMC_EC_SDO_VALUE",         "2")
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x80${ECMC_EC_CH_ID}0,$(ECMC_EC_SDO_INDEX_OFFSET),$(ECMC_EC_SDO_VALUE),$(ECMC_EC_SDO_SIZE))"
