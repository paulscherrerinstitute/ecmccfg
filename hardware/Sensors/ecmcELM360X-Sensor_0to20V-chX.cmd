#-d /**
#-d   \brief hardware script for ELM360X for 0..20V range
#-d   \details Parametrization of ELM360X for 0..20V range used for voltage measurement (not IEPE)
...
#- 0..20V Setting (107)
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x80${ECMC_SDO_ID_LOCAL}0,0x1,107,2)"
