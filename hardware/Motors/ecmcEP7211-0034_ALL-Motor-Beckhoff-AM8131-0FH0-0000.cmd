...
#-d   \details Parmetrization of EP7211 for motor Beckhoff AM8131-0FH0-0000
#-d   \author Niko Kivel
#-d   \file
...
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8011,0x11,5000,4)"
...
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8011,0x2d,14400,2)"

#- 0x9009 0x13 Maximum speed (rpm)
#- --> 10000 (reset by auto-configuration to 5406)
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8011,0x1b,3000,4)"
#-
...
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x8010,0x15,50,4)"
