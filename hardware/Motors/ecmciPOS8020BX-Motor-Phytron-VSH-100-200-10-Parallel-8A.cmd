...
#-  IMAXPROT=Imax*819=10.0*819=8190 (0x1FFE)

#-  Write data IMAXPROT=0x1FFE
epicsEnvSet("ECMC_TECHNOSOFT_ADR_HEX"          "0295")
epicsEnvSet("ECMC_TECHNOSOFT_DATA_HEX"         "1FFE")
${SCRIPTEXEC} ${ecmccfg_DIR}technosoftWriteGenericCfg.cmd
...
#-  Stepper current in open loop configuration 8A => 6552 (Isetting=2*Ipeak/65520*I, Ipeak=40A =>Isetting=819*I)
...
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},0x2026,0x0,819,4)"
