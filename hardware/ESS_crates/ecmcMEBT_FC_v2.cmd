...
#5  0:5  PREOP  +  EL3214 4K. Ana. Eingang PT100 (RTD)
...
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=3, HW_DESC=EL3602"

# Configure EL4004 analog output terminal 0-10V, 12 bit
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=4, HW_DESC=EL4134"

# Configure EL3214 4K. Ana. Eingang PT100 (RTD)
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=5, HW_DESC=EL3214"
