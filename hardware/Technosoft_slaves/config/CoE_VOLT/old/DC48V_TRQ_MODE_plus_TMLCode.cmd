...
#      Input file name: DC48V_TRQ_MODE_plus_TMLCode.sw
#      Block start adress: 0x7abf
#      Output file name: DC48V_TRQ_MODE_plus_TMLCode.cmd
#      Date: 2024/06/21 08:36:44
#########################################################
...
ecmcConfigOrDie "Cfg.EcWriteSdo(${ECMC_EC_SLAVE_NUM},0x2065,0x0,0x43C8,4)"
epicsThreadSleep(0.01)
ecmcConfigOrDie "Cfg.EcWriteSdo(${ECMC_EC_SLAVE_NUM},0x2065,0x0,0x2A03,4)"
epicsThreadSleep(0.01)
...
#      Offline calculated checksum: 0x5406 (21510)
#      Online calculated checksum (in drive) (in dec..):
ecmcConfig "EcReadSdo(${ECMC_EC_SLAVE_NUM},0x206A,0x0,2)"
ecmcConfigOrDie "Cfg.EcVerifySdo(${ECMC_EC_SLAVE_NUM},0x206A,0x0,0x5406,2)"
#########################################################
