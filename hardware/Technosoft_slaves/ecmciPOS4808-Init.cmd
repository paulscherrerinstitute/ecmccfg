...
${SCRIPTEXEC} ${ecmccfg_DIR}configureSlave.cmd, "SLAVE_ID=42, HW_DESC=IPOS4808, CONFIG=-Motor-McLennan-34HT18C340-Parallel"

# Download base config (parsed from Techosoft EasySetup configuration): Only needed first time a drive is used..
${SCRIPTEXEC} ${ecmccfg_DIR}ecmciPOS4808-EEPROM-BaseConfig-StepperOpenLoopCSV.cmd
