#-d /**
#-d   \brief hardware script for ecmcEL5042-Encoder-Posital-KCD-BC03B-1617-XXXX-XXX.cmd
#-d   \details Posital Biss-C 24-bit encoder, encoder sends 26-bit with LSB at 2
#-d   \author Niko Kivel
#-d   \file
...
#- default
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},${ECMC_EC_SDO_INDEX},0x15,16,1)"
