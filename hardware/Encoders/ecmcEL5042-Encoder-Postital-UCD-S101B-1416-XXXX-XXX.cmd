#-d /**
#-d   \brief hardware script for ecmcEL5042-Encoder-UCD-S101B-1416-XXXX-XXX
#-d   \details SSI encoder Postital UCD-S101B-1416
#-d   \author Niko Kivel
#-d   \file
...
#-d   \note Supply:     4.5..30 VDC
#-d   \note Resolution: 16/14 => 30 bits total
#-d */
...
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},${ECMC_EC_SDO_INDEX},0x15,14,1)"

#- 0x80p8:16: Singleturn [Bit] Number of singleturn bits (17 data)
#- WORKING with 33 bit
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},${ECMC_EC_SDO_INDEX},0x16,16,1)"
