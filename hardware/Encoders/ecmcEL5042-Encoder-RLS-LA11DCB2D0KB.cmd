#-d /**
#-d   \brief hardware script for ecmcEL5042-Encoder-RLS-LA1DCB2D0KB.cmd
#-d   \details RLS Biss-C 22-bit encoder, encoder sends 24-bit with LSB at 2
#-d   \author Niko Kivel
#-d   \file
...
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},${ECMC_EC_SDO_INDEX},0x11,67,4)"
...
#- default 13
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},${ECMC_EC_SDO_INDEX},0x16,24,1)"

#- 0x80p8:17: Offset LSB Bit [Bit] Number of “right aligned” Offset bits
#- default 0
ecmcConfigOrDie "Cfg.EcAddSdo(${ECMC_EC_SLAVE_NUM},${ECMC_EC_SDO_INDEX},0x17,2,1)"
