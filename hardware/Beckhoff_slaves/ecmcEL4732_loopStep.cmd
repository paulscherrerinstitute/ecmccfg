...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},1,${SYNC_MAN},0x1${ECMC_PDO_HEX_VALUE},0x7${ECMC_ENTRY_HEX_VALUE}0,0x${PDO_ENTRY_OFFSET},S16,CH${CH_ID}_VALUE_${ECMC_LOOP_IDX},0)"
