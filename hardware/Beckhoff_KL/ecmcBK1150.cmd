#-d /**
#-d   \brief hardware script for BK1150
...
#-d   togheter with an BK1150 or similar.
#-d   The BL1150 coupler automatically scans the bus and generates pdos for the terminals downstream.
...
#-d   - ECMC_EC_SLAVE_NUM  : The slave number of the BK1150
#-d   (- ECMC_KL_SLAVE_NUM  : The slave number of the KL terminal starting at "00" at the first terminal _after_ the BK1150 
#-d                          Must always be a 2 digit hex number (without "0x").. Example: "1A" for slave 26(decimal))
#-d   - ECMC_EC_VENDOR_ID  : The vendor id of BK1150 (or similar)
#-d   - ECMC_EC_PRODUCT_ID : The product id of BK1150 (or similar)
#-d
#-d   \author Anders Sandstroem, Markus Kristensson
#-d   \file
#-d */

epicsEnvSet("ECMC_EC_HWTYPE"             "BK1150")
...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1aff,0xf100,0x1,U16,BK1150_STATUS)"

#- Control word
#- 0x0010 = Disable outputs
#- 0x0020 = Show K-Bus overrun
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},1,2,0x16ff,0xf200,0x1,U16,BK1150_CONTROL)"
