...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a01,0x60${ECMC_KL_SLAVE_NUM}0,0x9,B1,BK_S${ECMC_KL_SLAVE_NUM}_BI_9)"
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a01,0x60${ECMC_KL_SLAVE_NUM}0,0xA,B1,BK_S${ECMC_KL_SLAVE_NUM}_BI_10)"
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a01,0x60${ECMC_KL_SLAVE_NUM}0,0xB,B1,BK_S${ECMC_KL_SLAVE_NUM}_BI_11)"
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a01,0x60${ECMC_KL_SLAVE_NUM}0,0xC,B1,BK_S${ECMC_KL_SLAVE_NUM}_BI_12)"
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a01,0x60${ECMC_KL_SLAVE_NUM}0,0xD,B1,BK_S${ECMC_KL_SLAVE_NUM}_BI_13)"
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a01,0x60${ECMC_KL_SLAVE_NUM}0,0xE,B1,BK_S${ECMC_KL_SLAVE_NUM}_BI_14)"
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a01,0x60${ECMC_KL_SLAVE_NUM}0,0xF,B1,BK_S${ECMC_KL_SLAVE_NUM}_BI_15)"
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a01,0x60${ECMC_KL_SLAVE_NUM}0,0x10,B1,BK_S${ECMC_KL_SLAVE_NUM}_BI_16)"
