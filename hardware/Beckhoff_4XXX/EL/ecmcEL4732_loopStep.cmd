...
ecmcEpicsEnvSetCalc("ECMC_PDO_HEX_VALUE",${ECMC_LOOP_IDX}-1+${PDO_OFFSET},"%03x")

ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},1,${SYNC_MAN},0x1${ECMC_PDO_HEX_VALUE},0x7${ECMC_ENTRY_HEX_VALUE}0,0x${PDO_ENTRY_OFFSET},S16,analogOutput${CH_ID}_${ECMC_LOOP_IDX},0)"
