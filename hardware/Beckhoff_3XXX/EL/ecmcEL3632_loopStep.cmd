...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,3,0x1a${ECMC_PDO_HEX_VALUE},0x60${PDO_ENTRY_LAST_2_DIGITS},0x${ECMC_ENTRY_OFFSET_HEX_VALUE},S16,CH${CH_ID}_VALUE_${ECMC_LOOP_IDX},0)"
