...
ecmcForLoop(${ecmccfg_DIR}ecmcEL3702_loopStep.cmd,"CH_ID=01, PDO_OFFSET=0, PDO_ENTRY_OFFSET=1, SYNC_MAN=0",ECMC_LOOP_IDX,1,${NELM=1},1)
...
#- Inflate all pdos with a for loop
ecmcFileExist(${ecmccfg_DIR}ecmcEL3702_loopStep.cmd,1)
ecmcForLoop(${ecmccfg_DIR}ecmcEL3702_loopStep.cmd,"CH_ID=02, PDO_OFFSET=128, PDO_ENTRY_OFFSET=2, SYNC_MAN=1",ECMC_LOOP_IDX,1,${NELM=1},1)
