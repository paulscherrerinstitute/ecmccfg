...
${SCRIPTEXEC} ${ecmccfg_DIR}loadPLCFile.cmd,    "FILE=./cfg/test.plc"
dbLoadRecords("./ecmcPlcAnalogInput.db","P=$(IOC):,PORT=MC_CPU1,ASYN_NAME=plcs.plc0.static.testvalue,REC_NAME=TestValue")
