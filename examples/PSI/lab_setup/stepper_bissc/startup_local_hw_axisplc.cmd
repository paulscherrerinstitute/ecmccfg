...
require ecmccfg v11.0.0_RC1 "ECMC_VER=v11.0.0_RC1,ENG_MODE=1,MASTER_ID=0"
...
${SCRIPTEXEC} ${ecmccfg_DIR}loadYamlAxis.cmd,   "FILE=./cfg/axis_lookup_plc.yaml,     DEV=${IOC}, AX_NAME=M1, AXIS_ID=1, DRV_SID=${DRV_SID}, ENC_SID=${ENC_SID}, ENC_CH=01"
