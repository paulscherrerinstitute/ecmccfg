...
#- DS for test 
$(SCRIPTEXEC) $(ecmccfg_DIR)addDataStorage.cmd "DS_ID=0,DS_SIZE=${DS_SIZE=10}"

#- Just for test..
${SCRIPTEXEC} ${ecmccfg_DIR}loadPLCFile.cmd     "FILE=./cfg/target_var.plc, SAMPLE_RATE_MS=1000, PLC_MACROS='DRV_SID=${DRV_SID}'"
