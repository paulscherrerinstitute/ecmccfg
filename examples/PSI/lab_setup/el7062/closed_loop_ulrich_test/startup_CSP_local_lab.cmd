...
require ecmccfg v10.1.0_RC1 "ENG_MODE=1,ECMC_VER=v10.1.0_RC1"
...
${SCRIPTEXEC} ${ecmccfg_DIR}loadYamlAxis.cmd,   "FILE=./cfg/axis_open_loop_CSP_local_lab.yaml,   DEV=${IOC}, AX_NAME=M1, AXIS_ID=1, DRV_SID=${DRV_SID}, BO_SID=$(BO_SID)"
${SCRIPTEXEC} ${ecmccfg_DIR}loadYamlEnc.cmd,    "FILE=./cfg/enc_biss_local_lab.yaml, DEV=${IOC}, ENC_SID=${ENC_SID}"
