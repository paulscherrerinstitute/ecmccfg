...
epicsEnvSet("ECMC_HOME_VEL_TO",           "5")                              # Velocity used when searching for first cam
epicsEnvSet("ECMC_HOME_VEL_FRM",          "4")                              # Velocity used when searching for cams (during position latching)
