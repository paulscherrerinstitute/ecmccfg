...
Fields supported by yaml motion cfg:
```
axis:
  id: 1                                               # Axis id
  ...
  features: 
    blockCom: 1                                       # Block communication to axis
    allowedFunctions:
...
input:
  ...
  home: ''                                            # Ethercat entry for home switch
...
softlimits:
  ...
  forwardEnable: 1                                    # Soft limit position fwd enable
  backward: -100                                      # Soft limit position bwd
  backwardEnable: 1                                   # Soft limit position bwd enable
...
#  filter:
#    velocity:                                        # Filter plc velo
#      enable: false
#      size: 100
#    trajectory:                                      # Filter plc traj
#      enable: false
#      size: 100
```
