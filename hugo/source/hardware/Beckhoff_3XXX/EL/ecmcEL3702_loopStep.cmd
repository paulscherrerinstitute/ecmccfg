...
ecmcConfigOrDie "Cfg.EcAddEntryDT(${ECMC_EC_SLAVE_NUM},${ECMC_EC_VENDOR_ID},${ECMC_EC_PRODUCT_ID},2,${SYNC_MAN},0x1a${ECMC_PDO_HEX_VALUE},0x6${ECMC_ENTRY_HEX_VALUE}0,0x${PDO_ENTRY_OFFSET},S16,analogInputArray${CH_ID}_${ECMC_LOOP_IDX},0)"
