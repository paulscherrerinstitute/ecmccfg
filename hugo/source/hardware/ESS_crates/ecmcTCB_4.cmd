...
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=64, HW_DESC=EK1100"

#Configure EL2502 PWM output
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=65, HW_DESC=EL2502"
...
#Configure EL2502 PWM output
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=66, HW_DESC=EL2502"
...
#Configure EL2502 PWM output
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=67, HW_DESC=EL2502"
...
#Configure EL2502 PWM output
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=68, HW_DESC=EL2502"
...
#Configure EL2502 PWM output
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=69, HW_DESC=EL2502"
...
#Configure EL2502 PWM output
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=70, HW_DESC=EL2502"
...
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=71, HW_DESC=EL9410"

# Configure EL3202-0010 PT100
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=72, HW_DESC=EL3202-0010"
...
# Configure EL3202-0010 PT100
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=73, HW_DESC=EL3202-0010"
...
# Configure EL3202-0010 PT100
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=74, HW_DESC=EL3202-0010"
...
# Configure EL3202-0010 PT100
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=75, HW_DESC=EL3202-0010"
...
# Configure EL3202-0010 PT100
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=76, HW_DESC=EL3202-0010"
...
# Configure EL3202-0010 PT100
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=77, HW_DESC=EL3202-0010"
...
# Configure EL3202-0010 PT100
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=78, HW_DESC=EL3202-0010"
...
# Configure EL3202-0010 PT100
${SCRIPTEXEC} ${ecmccfg_DIR}addSlave.cmd, "SLAVE_ID=79, HW_DESC=EL3202-0010"
