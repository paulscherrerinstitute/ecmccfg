...
${SCRIPTEXEC} ${ecmccfg_DIR}configureSlave.cmd, "SLAVE_ID=20, HW_DESC=EL7047, CONFIG=-Motor-Nanotec-ST4118L1804-B"

#Configure EL7037 stepper drive terminal, motor 2
${SCRIPTEXEC} ${ecmccfg_DIR}configureSlave.cmd, "SLAVE_ID=21, HW_DESC=EL7047, CONFIG=-Motor-Nanotec-ST4118L1804-B"
