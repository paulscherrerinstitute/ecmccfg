...
dbLoadRecords("ecmcMcuConfigs.db","P=${ECMC_PREFIX},AXES_IDS='${ECMC_AXES_CFG=""}',PLC_IDS='${ECMC_PLCS_CFG=""}',DS_IDS='${ECMC_DS_CFG=""}', PLG_IDS='${ECMC_PLG_CFG=""}',M_ID=${ECMC_EC_MASTER_ID=-1}")
