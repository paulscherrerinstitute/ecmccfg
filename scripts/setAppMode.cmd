...
dbLoadRecords("ecmcControllerConfigs.db","P=${SM_PREFIX},AXES_IDS='${ECMC_AXES_CFG=""}',M_ID=${ECMC_EC_MASTER_ID} ,PLC_IDS='${ECMC_PLCS_CFG=""}',DS_IDS='${ECMC_DS_CFG=""}', PLG_IDS='${ECMC_PLG_CFG=""}', EC_IDS='${ECMC_EC_CFG=""}',MCU_NAME=${ECMC_P_SCRIPT}")
