...
ecmcIf("'$(CFG_TOOL=jinja)'=='ecb'")
  ${IF_TRUE}system "ecb --yaml ${FILE} --schemafile ${ECMC_CONFIG_ROOT}ecbSchema.json --schema encoder --template ${ECMC_CONFIG_ROOT}add_encoder.jinja2 --templatedir ${ECMC_CONFIG_ROOT} --output ${ECMC_TMP_DIR}${FILE}.enc"
#- else
