...
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_11=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_12=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_13=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_14=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_15=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_16=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_17=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_18=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_19=''}"
ecmcConfigOrDie "Cfg.AppendAxisPLCExpr(${ECMC_AXIS_NO})=${ECMC_AXIS_EXPR_LINE_20=''}"
