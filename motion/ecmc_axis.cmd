...
ecmcFileExist(${ECMC_MR_MODULE="ecmcMotorRecord"}.template,1,${EPICS_DB_INCLUDE_PATH})
...
ecmcFileExist(${ECMC_MR_MODULE="ecmcMotorRecord"}home.template,1,${EPICS_DB_INCLUDE_PATH})
...
ecmcFileExist("ecmcExpression.db",1,${EPICS_DB_INCLUDE_PATH})
