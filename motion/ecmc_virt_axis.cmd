...
#- General (Note ECMC_DRV_TYPE not used for virt axis)
ecmcConfigOrDie "Cfg.CreateAxis(${ECMC_AXIS_NO},2,${ECMC_DRV_TYPE=0},${ECMC_TRAJ_TYPE=0})"
...
epicsEnvSet(ECMC_AXES_CFG,"${ECMC_AXES_CFG=""}${ECMC_AXIS_NO}, ")
